...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($tabla == "equipos") {
            ...
            if ($idEquipo == "" || $nombre == "" || $ciudad == "" || $estadio == "") {
            ...
            if ($idJugador == "" || $nombre == "" || $idEquipo == "" || $posicion == "" || $nacionalidad == "" || $edad == "") {
    ...
    <div class="container m-4">
        <h1>ACTUALIZAR DATOS A LA BBDD</h1>
        <form action="" method="post">
            <div class="mb-3">
                <label for="seleccion" class="form-label">Actualizar datos en la tabla: </label>
            ...
            <div id="campoEquipo" class="mb-3" style="display: none;">
                ...
                <input type="text" name="idEquipo" class="form-control" placeholder="Escribe el ID del equipo..."><br>
            ...
            <div id="campoJugador" class="mb-3" style="display: none;">
                <h2>Actualizar un jugador:</h2>
                <label for="idJugador" class="form-label">ID:</label>
                <input type="text" name="idJugador" class="form-control" placeholder="Escribe el ID del futbolista..."><br>
